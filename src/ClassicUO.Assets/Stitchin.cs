...
namespace ClassicUO.Assets
{
    ...
    {
        /// <summary>
        /// For now this system is disabled, this is to test it live
        /// </summary>
        ...
        public bool TryGetEntry(ushort animID, out StitchinEntry entry) => _entries.TryGetValue(animID, out entry);
        ...
        private static bool IsEndDef(string line) => line.StartsWith("# enddef") || line.StartsWith("#enddef");
        ...
        private void ParseBlock(List<string> lines)
        {
            ...
            string[] headerArgs = lines[0].Split(_split, StringSplitOptions.RemoveEmptyEntries);
            ...
            {
                string[] args = lines[i].Split(_split, StringSplitOptions.RemoveEmptyEntries);
